...
namespace raw {
    ...
    public:
        ...
        explicit shared_ptr(T *p) noexcept {
            if (p) {
                this->ptr = p;
                this->hub_ptr = new hub(this->ptr, nullptr, &raw::deleters::delete_single_object<T>,
                                        &raw::deleters::deallocate_hub_for_new_single);
            } else {
                this->ptr = nullptr;
                this->hub_ptr = nullptr;
            }
    ...
    public:
        ...
        explicit shared_ptr(T *p) noexcept {
            if (p != nullptr) {
                this->ptr = p;
                this->hub_ptr = new hub(this->ptr, nullptr, &raw::deleters::delete_array_object<T>,
                                        &raw::deleters::deallocate_hub_for_new_array);
            } else {
                this->ptr = nullptr;
                this->hub_ptr = nullptr;
            }
