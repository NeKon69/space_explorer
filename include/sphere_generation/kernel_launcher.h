...
namespace raw::sphere_generation {
    extern void launch_tessellation(const raw::vertex *in_vertices, const UI *in_indices,
                                    ...
                                    size_t num_input_triangles, cuda_types::cuda_stream &stream);

    extern void launch_orthogonalization(raw::vertex *vertices, size_t num_vertices,
                                         cuda_types::cuda_stream &stream);
} // namespace raw::sphere_generation
