...
//	key_bindings[SDL_SCANCODE_T] = std::make_shared<raw::command::directional_light_change_state>();
//	key_bindings[SDL_SCANCODE_P] = std::make_shared<raw::command::change_simulation_running>();
}
